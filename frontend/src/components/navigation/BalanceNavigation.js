        ...
        <div className="mobileNav">
          <ul className="mobileNav__items">
            ...
            <li className="mobileNavItem mobileNavItem--call-to-action"><a
              className="mobileNavItem__link"><span
            ...
            <li className="mobileNavItem"><a className="mobileNavItem__link"><span
        ...
        <div className="sidebar-container column-layout-left bg-primary">
          <div className="nav-sidebar">
            <div className="nav-sidebar__top">
              <div className="nav-sidebar-brand"><a><img
            ...
            <div className="nav-sidebar__body">
              <div className="menu-section">
                <div className="menu-item "><a><span
                ...
                <div className="menu-item "><a><span className="tw-icon tw-icon-team "
                                                     aria-hidden="true"
              ...
              <div className="balance-group">
                ...
                <BalanceList/>
                <a className="balance-group__action"><span
                             ...
                             <span class="tw-icon tw-icon-notification " aria-hidden="true" role="presentation">
                                <svg width="24" height="24" fill="currentColor" focusable="false">
                                   <path fill-rule="evenodd" clip-rule="evenodd"
                                         d="M12 2a7 7 0 00-7 7v4.405L3.602 17.5h16.796L19 13.405V9a7 7 0 00-7-7zM7 9a5 5 0 0110 0v4.738l.602 1.762H6.398L7 13.738V9z"></path>
              ...
              <div class="nav-toolbar nav-toolbar--compact p-b-2">
                <div class="container m-l-0 hidden-xs">
                  ...
                  <div class="action-buttons p-l-0 pull-right">
                    <div class="btn-toolbar btn-toolbar-sm line-height-0">
                      <div class="btn-block">
                        <button type="button" class="btn btn-sm np-btn np-btn-sm btn-accent btn-priority-2">Statements</button>
                        <button type="button" class="btn btn-sm np-btn np-btn-sm btn-accent btn-priority-2">Direct Debits</button>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="p-a-panel" role="button" tabindex="0">
                      <div class="media">
                        <div class="bank-details-left">
                          <div class="circle circle-sm circle-responsive circle-inverse">
                                      <span class="tw-icon tw-icon-bank center-icon" aria-hidden="true" role="presentation">
                                         <svg width="24" height="24" fill="currentColor" focusable="false">
                                            <path
                                              d="M22.003 9.408l-10-7.405-10 7.405 1.195 1.595 8.805-6.52 8.805 6.52 1.195-1.595z"></path>
                        ...
                        <div class="media-body">
                          ...
                          <small>With account details, you can start receiving bank transfers straight to this balance. You’ll get an
                            account number and BSB.</small>
                        </div>
                        <div class="media-right balance-overview__chevron-container text-info">
                                   <span class="tw-icon tw-icon-chevron-up tw-chevron chevron-color bottom" aria-hidden="true"
                                         role="presentation">
                                      <svg width="16" height="16" fill="currentColor" focusable="false">
                                         <path fill-rule="evenodd" clip-rule="evenodd"
                                               d="M8 4l-6.6 6.653L2.537 11.8 8 6.293l5.463 5.507 1.137-1.147L8 4z"></path>
              ...
              <div class="m-t-section-3 m-b-section-3">
                <div class="row">
                  <div class="text-xs-center p-l-3 p-r-3 css-175e4ah">
                    <img src="https://wise.com/public-resources/assets/illustrations/empty_state_activity.svg"
                         alt="Illustration empty state" class="m-y-section-1"/>
