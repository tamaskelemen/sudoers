...
const Steps = ({amount = '2,230 HUF', rate = '364.520'}) => {
  return (
    <div>
      <ul
        ...
        <li><span className="sequence-icon tw-calculator-breakdown__icon">–</span><span
          className="tw-calculator-breakdown-item__left"><strong data-testid="tw-money-wrapper-bold">{amount}</strong></span><span
          className="tw-calculator-breakdown-item__right">
          <span
          style={{textTransform:'none'}}>fee</span></span></li>
        <li><span className="sequence-icon tw-calculator-breakdown__icon">=</span><span className="tw-calculator-breakdown-item__left">497,769 HUF</span><span
        ...
        <li><span className="sequence-icon tw-calculator-breakdown__icon">÷</span><span className="tw-calculator-breakdown-item__left"><a
          role="button" tabIndex="0"><span className="tw-calculator-breakdown-rate__value">{rate}</span><span
          ...
          type="button" className="btn-unstyled" data-toggle="popover"><span data-tracking-id="calculator-fixed-rate-tooltip" id="estimatedLabel">Estimated rate</span></button></span><div
